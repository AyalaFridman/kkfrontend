...
const Fund_Details = observer(() => {
    ...
    useEffect(() => {
        fundStore.getFundAllocations(id)
            .then(() => {
                console.log(fundStore.currentFund);
                console.log("allocations", fundStore.currentFundAllocations)
                // ברגע שהנתונים טוענים, נעדכן את הטופס
                // reset(fundStore.currentfund); // reset את הטופס עם הנתונים
            })
            .catch((error) => {
        ...
        <CacheProvider value={cacheRtl}>
            <ThemeProvider theme={theme}>
                ...
                >
                    ...
                    <DataGrid
                        rows={fundStore.currentFundAllocations}
                        columns={columns}
